...
namespace IoTHubManager
{
    ...
    public class CreateDeviceTest
    {
        ...
        {
            Console.WriteLine("Running 1st CreateDeviceTest Tests");
            ...
            Console.WriteLine("Request in CreateDeviceTest Tests");
            // Asserts
        ...
        {
            Console.WriteLine("Running 2nd CreateDeviceTest Tests");
        ...
        {
            Console.WriteLine("Running 3rd CreateDeviceTest Tests");
            string id = Guid.NewGuid().ToString(),
        ...
        {
            Console.WriteLine("Running 4th CreateDeviceTest Tests");
            // DeviceId must be empty to be auto generated.
        ...
        {
            Console.WriteLine("Running 5th CreateDeviceTest Tests");
            string id = Guid.NewGuid().ToString(),
        ...
        {
            Console.WriteLine("Running 6th CreateDeviceTest Tests");
            // DeviceId must be empty to be auto generated.
